...
export const template = (attributes: Attributes): string => `
    <div class="${styles.container}" data-select="container">
        ...
        <p class="${styles.paragraph}">${attributes.paragraph}</p>
        <button class="${styles.button}" data-select="button">${attributes.button}</button>
    </div>
`;
